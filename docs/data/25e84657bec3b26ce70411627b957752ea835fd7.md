...
- Name: Booking In Report Filter Flow
- Location: /home/tops/Hitesh/Automation/Poundshop/tests/Live_sanity/018_Booking_In_Report.spec.js:5:5

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('cell', { name: '25' }) resolved to 3 elements:
    1) <th colspan="5" class="datepicker-switch">June 2025</th> aka getByRole('cell', { name: 'June' })
    2) <td class="old day">25</td> aka getByRole('cell', { name: '25' }).nth(1)
    3) <td class="day">25</td> aka getByRole('cell', { name: '25' }).nth(2)

Call log:
  - waiting for getByRole('cell', { name: '25' })

    at /home/tops/Hitesh/Automation/Poundshop/tests/Live_sanity/018_Booking_In_Report.spec.js:34:47
```
...
- heading "Booking In Report" [level=3]
- link "":
  - /url: https://erp.poundshop.com/booking-in/booking-in-report/export
- button " Filter (2) "
- heading "Filter by" [level=2]
- text: Warehouse
- combobox:
  - list:
    - listitem "Darton": × Darton
    - listitem "Wednesbury Warehouse": × Wednesbury Warehouse
    - listitem:
      - searchbox
- text: Date Range
- textbox "From Date": 26-Jun-2025
- textbox "To Date": 26-Jun-2025
- text: User
- combobox:
  - list:
    - listitem:
...
- grid:
  - rowgroup:
    - 'row "User: activate to sort column ascending Total SKUs: activate to sort column ascending Total Normal Received Qty: activate to sort column ascending Total Variation Received Qty: activate to sort column ascending Total Received Qty: activate to sort column ascending"':
      - 'columnheader "User: activate to sort column ascending"': User
      - 'columnheader "Total SKUs: activate to sort column ascending"': Total SKUs
      - 'columnheader "Total Normal Received Qty: activate to sort column ascending"': Total Normal Received Qty
      - 'columnheader "Total Variation Received Qty: activate to sort column ascending"': Total Variation Received Qty
      - 'columnheader "Total Received Qty: activate to sort column ascending"': Total Received Qty
- grid:
  - rowgroup:
    - 'row "User: activate to sort column ascending Total SKUs: activate to sort column ascending Total Normal Received Qty: activate to sort column ascending Total Variation Received Qty: activate to sort column ascending Total Received Qty: activate to sort column ascending"':
      - 'columnheader "User: activate to sort column ascending"': User
      ...
      - 'columnheader "Total Received Qty: activate to sort column ascending"': Total Received Qty
  - rowgroup:
    - row "Maria Stefania 293 36,699 0 36,699":
      - gridcell "Maria Stefania"
      - gridcell "293"
      - gridcell "36,699"
      - gridcell "0"
      - gridcell "36,699"
...
```ts
   ...
   4 |
   5 | test('Booking In Report Filter Flow', async ({ page }, testInfo) => {
  ...
  12 |
  13 |   // Step 2: Navigate to Goods In > Booking In Report
  14 |   console.log('Step 2: Navigating to Booking In Report...');
  15 |   await page.getByRole('link', { name: 'Goods In +' }).click();
  16 |   await page.waitForTimeout(1000);
  17 |   await page.getByRole('link', { name: 'Booking In Report' }).click();
  18 |   await page.waitForLoadState('networkidle');
  19 |   await page.waitForTimeout(2000);
  20 |
  21 |   // Step 3: Open Filter Panel
  22 |   console.log('Step 3: Opening filter panel...');
  23 |   await page.getByRole('button', { name: 'Filter (2) ' }).click();
  24 |   await page.waitForTimeout(1000);
  25 |
  26 |   // Step 4: Select From Date
  27 |   console.log('Step 4: Selecting Previous day as From Date...');
  28 |   // Get yesterday's date in the required format
  29 |   const yesterday = new Date();
  30 |   yesterday.setDate(yesterday.getDate() - 1);
  31 |   const day = yesterday.getDate().toString();
  32 |
  33 |   await page.getByRole('textbox', { name: 'From Date' }).click();
> 34 |   await page.getByRole('cell', { name: day }).click();
     |                                               ^ Error: locator.click: Error: strict mode violation: getByRole('cell', { name: '25' }) resolved to 3 elements:
  35 |   await page.waitForTimeout(1000);
  36 |
  37 |   // Step 5: Apply the filter
  38 |   console.log('Step 5: Clicking Apply filter...');
  39 |   await page.getByRole('button', { name: 'Apply' }).click();
  40 |   await page.waitForLoadState('networkidle');
  41 |   await page.waitForTimeout(2000);
  42 |
  43 |   // Step 6: Reopen filter (now showing 3 applied)
  44 |   console.log('Step 6: Reopening filter panel...');
  45 |   await page.getByRole('button', { name: 'Filter (3)' }).click();
  46 |   await page.waitForTimeout(1000);
  47 |
  48 |   // Step 7: Click Cancel to close filter panel
  49 |   console.log('Step 7: Closing filter panel by clicking Cancel...');
  50 |   await page.getByRole('button', { name: 'Cancel' }).click();
  51 |   await page.waitForTimeout(1000);
  52 |
  53 |   console.log('Booking In Report test completed.');
  54 | });
```